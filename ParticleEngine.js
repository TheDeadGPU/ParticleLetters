...
export class ParticleEngine {
    ...
    Add(_particle) {
        ...
        this.scene.add(_particle.GenerateParticleMesh());
        //this.scene.children[0].position.x = 2;
    }
    ...
    AnimateParticles(_timeDiff, _mousePositionX, _mousePositionY) {
        ...
        for (let i = 0; i < this.particles.length; i++) {
            ...
            var particleMesh = this.scene.children[i]
            ...
            particleMesh.position.x = particle.x;
            particleMesh.position.y = particle.y;
